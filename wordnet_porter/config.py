#!/usr/bin/env python3
# wordnet_porter/config.py
"""
Configuration module for WordNet Porter.

This module defines the configuration settings for the WordNet Porter application,
...
class Config:
    ...
    def __init__(self):
        ...
        self.user_config_dir: Path = Path.home() / ".wordnet_porter"
    ...
    def ensure_pg_credentials(self) -> bool:
        ...
        """
        # Check if credentials are already in settings
