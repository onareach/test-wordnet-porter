#!/usr/bin/env python3
# wordnet_porter/cli.py
"""
Command-line interface module for WordNet Porter.

This module handles command-line argument parsing and validation for the
WordNet Porter application.
"""
import sys
import logging
...
def show_help() -> None:
    ...
    print("""
📘 WordNet to PostgreSQL Porting Tool
...
Example usage:
  ...
  python3 -m wordnet_porter.main --list_steps
  python3 -m wordnet_porter.main --start_step 5 --end_step 9
  python3 -m wordnet_porter.main --only_step 6 --force
""")
    sys.exit(0)
