#!/bin/bash
# WordNet Porter Installation Script
...
echo -e "${YELLOW}WordNet Porter Installation${NC}"
echo "=============================="
...
echo "Installing WordNet Porter..."
pip install -e . || {
    echo -e "${RED}Error: Failed to install WordNet Porter.${NC}"
    exit 1
}
...
echo "source wordnet_porter_venv/bin/activate"
echo ""
echo "To start WordNet Porter, run:"
echo "python main.py"
echo ""
